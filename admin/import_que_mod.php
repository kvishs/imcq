    ...
    <div class="modal-dialog">
      <div class="modal-content">      
        ...
        <div class="modal-body">         
			<form method="post" class="form-horizontal" action="import_que_excel" enctype="multipart/form-data">							<div class="form-group">
        ...
        <a href="../assets/uploads/Paper/import_ques_formate.xlsx" class="btn">Click to View Excel file Format</a>       
        <!-- Modal footer -->
